...
def test_schema_version() -> None:
    assert shared_types.SCREENPLAY_SCHEMA_VERSION == "0.1.0"


def test_schema_doc_version() -> None:
    assert shared_types.SCREENPLAY_SCHEMA_DOC_VERSION == "0.1.0"


def test_generator_version() -> None:
    assert shared_types.SCREENPLAY_GENERATOR_VERSION == "0.1.0"
